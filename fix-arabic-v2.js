...
// Let's manually reconstruct the first few duas to test,
// then maybe we can find a better way, but for now let's just create a new duas.ts with correct Arabic.

const newDuasContent = `export type Dua = {
  id: string;
  keywords: string[];
  category: string;
  arabic: string;
...
fs.writeFileSync(filePath, newDuasContent, 'utf8');
console.log('Duas file has been updated with correct Arabic text for the first few duas!');
